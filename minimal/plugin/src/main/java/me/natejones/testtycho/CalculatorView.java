...
public class CalculatorView extends ViewPart {
	...
	public void createPartControl(Composite parent) {
		...
		numberField.setFont(SWTResourceManager
				.getFont("Segoe UI", 20, SWT.BOLD));
		numberField.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, false,
				1, 1));
		numberField.setEditable(false);
		/**
		 * Set up the ButtonField; an area where the Calculator buttons are
		 * held. Each button calls a method within the Calculator so that the
		 * Calculator can add a new argument or operation to its stack. After
		 * that method call, the button then appends its own value to the
		 * numberField.
		 */
		Composite buttonField = new Composite(parent, SWT.NONE);
		buttonField.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, true,
				1, 1));
		...
		btnThree.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, true, 1,
				1));
		btnThree.setText("3");
		...
		btnSeven.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, true, 1,
				1));
		btnSeven.setText("7");
		...
		btnEight.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, true, 1,
				1));
		btnEight.setText("8");
		...
		btnZero.setLayoutData(new GridData(SWT.FILL, SWT.FILL, false, false, 1,
				1));
		btnZero.setText("0");
		Button btnEqs = new Button(parent, SWT.NONE);
		btnEqs.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true, false, 1,
				1));
