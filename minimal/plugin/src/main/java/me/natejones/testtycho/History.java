...
public class History {
	 ...
	 * HistoryListeners that have identified themselves to this class are notified
	 * that the history has changed.
	 * 
	 * @param eq A String representation of the Calculator equation 
